...
export interface MirrorSubscriberInterface extends utils.Interface {
  functions: {
...
export interface MirrorSubscriber extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MirrorSubscriberInterface;
