...
import type { IBaseWorld, IBaseWorldInterface } from "../IBaseWorld";
...
export class IBaseWorld__factory {
  static readonly abi = _abi;
  static createInterface(): IBaseWorldInterface {
    return new utils.Interface(_abi) as IBaseWorldInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBaseWorld {
    return new Contract(address, _abi, signerOrProvider) as IBaseWorld;
  }
}
