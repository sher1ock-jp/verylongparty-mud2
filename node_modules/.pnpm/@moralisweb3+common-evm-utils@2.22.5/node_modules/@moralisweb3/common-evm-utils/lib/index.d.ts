...
type EvmErc20TransferFromWalletLabelJSON = string | null;
type EvmErc20TransferFromWalletLabelInput = string | null;
type EvmErc20TransferFromWalletLabelValue = string | null;
declare abstract class EvmErc20TransferFromWalletLabel {
    static create(input: EvmErc20TransferFromWalletLabelInput): EvmErc20TransferFromWalletLabelValue;
    static fromJSON(json: EvmErc20TransferFromWalletLabelJSON): EvmErc20TransferFromWalletLabelValue;
    static toJSON(value: EvmErc20TransferFromWalletLabelValue): EvmErc20TransferFromWalletLabelJSON;
}

type EvmErc20TransferToWalletLabelJSON = string | null;
type EvmErc20TransferToWalletLabelInput = string | null;
type EvmErc20TransferToWalletLabelValue = string | null;
declare abstract class EvmErc20TransferToWalletLabel {
    static create(input: EvmErc20TransferToWalletLabelInput): EvmErc20TransferToWalletLabelValue;
    static fromJSON(json: EvmErc20TransferToWalletLabelJSON): EvmErc20TransferToWalletLabelValue;
    static toJSON(value: EvmErc20TransferToWalletLabelValue): EvmErc20TransferToWalletLabelJSON;
}
...
declare class EvmErc20Transfer {
     ...
     */
    readonly fromWalletLabel?: EvmErc20TransferFromWalletLabelValue;
    /**
     * @description The address of the contract
     */
     ...
     */
    readonly toWalletLabel?: EvmErc20TransferToWalletLabelValue;
    /**
     * @description The value of the transfer
     */
    readonly value: string;
