...
var _a$1, _b, _c;
class VercelPgPreparedQuery extends alias.PreparedQuery {
...
class VercelPgSession extends alias.PgSession {
    ...
    async transaction(transaction, config) {
        ...
        await tx.execute(alias.sql `begin${config ? alias.sql ` ${tx.getTransactionConfigSQL(config)}` : undefined}`);
        try {
...
class VercelPgTransaction extends alias.PgTransaction {
