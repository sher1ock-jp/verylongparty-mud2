...
export declare function useTransactionStore(): {
    ...
    setProvider: (newProvider: {
        ...
        estimateContractGas: <TChain extends unknown, const TAbi_1 extends unknown, TFunctionName extends string>(args: import("viem").EstimateContractGasParameters<TAbi_1, TFunctionName, TChain, import("viem").Account | undefined>) => Promise<bigint>;
        ...
        getBlock: <TIncludeTransactions extends boolean = false, TBlockTag extends import("viem").BlockTag = "latest">(args?: import("viem").GetBlockParameters<TIncludeTransactions, TBlockTag> | undefined) => Promise<import("viem").GetBlockReturnType<any, TIncludeTransactions, TBlockTag>>;
        ...
        getTransaction: <TBlockTag_1 extends import("viem").BlockTag = "latest">(args: import("viem").GetTransactionParameters<TBlockTag_1>) => Promise<import("viem").GetTransactionReturnType<any, TBlockTag_1>>;
        ...
        readContract: <const TAbi_4 extends unknown, TFunctionName_1 extends string>(args: import("viem").ReadContractParameters<TAbi_4, TFunctionName_1>) => Promise<unknown>;
        simulateContract: <const TAbi_5 extends unknown, TFunctionName_2 extends string, TChainOverride extends unknown>(args: import("viem").SimulateContractParameters<TAbi_5, TFunctionName_2, any, TChainOverride>) => Promise<import("viem").SimulateContractReturnType<TAbi_5, TFunctionName_2, any, TChainOverride>>;
        ...
        watchBlocks: <TIncludeTransactions_1 extends boolean = false, TBlockTag_2 extends import("viem").BlockTag = "latest">(args: import("viem").WatchBlocksParameters<import("viem").Transport, any, TIncludeTransactions_1, TBlockTag_2>) => import("viem").WatchBlocksReturnType;
        watchContractEvent: <const TAbi_6 extends unknown, TEventName_3 extends string, TStrict_5 extends boolean | undefined = undefined>(args: import("viem").WatchContractEventParameters<TAbi_6, TEventName_3, TStrict_5>) => import("viem").WatchContractEventReturnType;
        watchEvent: <const TAbiEvent_2 extends unknown = undefined, const TAbiEvents_2 extends readonly unknown[] | readonly AbiEvent[] | undefined = TAbiEvent_2 extends AbiEvent ? [TAbiEvent_2] : undefined, TStrict_6 extends boolean | undefined = undefined>(args: import("viem").WatchEventParameters<TAbiEvent_2, TAbiEvents_2, TStrict_6>) => import("viem").WatchEventReturnType;
        ...
        extend: <const client extends {
            ...
            type?: undefined;
            uid?: undefined;
        }>(fn: (client: import("viem").Client<import("viem").Transport, any, undefined, import("viem").PublicRpcSchema, import("viem").PublicActions<import("viem").Transport, any>>) => client) => import("viem").Client<import("viem").Transport, any, undefined, import("viem").PublicRpcSchema, { [K_1 in keyof client]: client[K_1]; } & import("viem").PublicActions<import("viem").Transport, any>>;
    }) => void;
