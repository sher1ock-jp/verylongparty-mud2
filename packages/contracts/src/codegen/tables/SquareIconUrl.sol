...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SquareIconUrl")));
bytes32 constant SquareIconUrlTableId = _tableId;

library SquareIconUrl {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SquareIconUrl", _fieldNames);
  }
