...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SquareQuest")));
bytes32 constant SquareQuestTableId = _tableId;
...
library SquareQuest {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SquareQuest", _fieldNames);
  }
