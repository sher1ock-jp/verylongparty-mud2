...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SquareCreatorEns")));
bytes32 constant SquareCreatorEnsTableId = _tableId;

library SquareCreatorEns {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SquareCreatorEns", _fieldNames);
  }
