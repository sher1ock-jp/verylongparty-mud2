...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SquareStopQualif")));
bytes32 constant SquareStopQualificationTableId = _tableId;

library SquareStopQualification {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SquareStopQualification", _fieldNames);
  }
