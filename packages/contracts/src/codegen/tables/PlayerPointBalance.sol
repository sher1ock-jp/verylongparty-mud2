...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerPointBalan")));
bytes32 constant PlayerPointBalanceTableId = _tableId;

library PlayerPointBalance {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayerPointBalance", _fieldNames);
  }
