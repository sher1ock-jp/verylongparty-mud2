...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerMapId")));
bytes32 constant PlayerMapIdTableId = _tableId;
...
library PlayerMapId {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayerMapId", _fieldNames);
  }
