...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerQuest")));
bytes32 constant PlayerQuestTableId = _tableId;
...
library PlayerQuest {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayerQuest", _fieldNames);
  }
