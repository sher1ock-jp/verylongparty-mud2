...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerIconUrl")));
bytes32 constant PlayerIconUrlTableId = _tableId;

library PlayerIconUrl {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayerIconUrl", _fieldNames);
  }
