...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerCoordinate")));
bytes32 constant PlayerCoordinatesTableId = _tableId;

struct PlayerCoordinatesData {
  uint32 x;
  uint32 y;
}

library PlayerCoordinates {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "x";
    _fieldNames[1] = "y";
    return ("PlayerCoordinates", _fieldNames);
  }
  ...
  /** Get the full data */
  function get(bytes32 key) internal view returns (PlayerCoordinatesData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function get(IStore _store, bytes32 key) internal view returns (PlayerCoordinatesData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function set(bytes32 key, PlayerCoordinatesData memory _table) internal {
    set(key, _table.x, _table.y);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 key, PlayerCoordinatesData memory _table) internal {
    set(_store, key, _table.x, _table.y);
  }

  /** Decode the tightly packed blob using this table's schema */
  function decode(bytes memory _blob) internal pure returns (PlayerCoordinatesData memory _table) {
