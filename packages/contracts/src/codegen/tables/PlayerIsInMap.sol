...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerIsInMap")));
bytes32 constant PlayerIsInMapTableId = _tableId;

library PlayerIsInMap {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayerIsInMap", _fieldNames);
  }
