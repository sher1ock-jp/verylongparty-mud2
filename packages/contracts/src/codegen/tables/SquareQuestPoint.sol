...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SquareQuestPoint")));
bytes32 constant SquareQuestPointTableId = _tableId;

library SquareQuestPoint {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SquareQuestPoint", _fieldNames);
  }
