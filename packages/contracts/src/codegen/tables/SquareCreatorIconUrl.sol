...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SquareCreatorIco")));
bytes32 constant SquareCreatorIconUrlTableId = _tableId;

library SquareCreatorIconUrl {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SquareCreatorIconUrl", _fieldNames);
  }
