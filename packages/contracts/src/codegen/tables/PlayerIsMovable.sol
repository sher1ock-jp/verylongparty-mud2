...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerIsMovable")));
bytes32 constant PlayerIsMovableTableId = _tableId;

library PlayerIsMovable {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayerIsMovable", _fieldNames);
  }
