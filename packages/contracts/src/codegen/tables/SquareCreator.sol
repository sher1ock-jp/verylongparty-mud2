...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SquareCreator")));
bytes32 constant SquareCreatorTableId = _tableId;

library SquareCreator {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SquareCreator", _fieldNames);
  }
