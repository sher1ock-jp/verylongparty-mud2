...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("VeryMonPosition")));
bytes32 constant VeryMonPositionTableId = _tableId;

library VeryMonPosition {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "x";
    _fieldNames[1] = "y";
    return ("VeryMonPosition", _fieldNames);
  }
