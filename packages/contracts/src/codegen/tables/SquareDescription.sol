...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SquareDescriptio")));
bytes32 constant SquareDescriptionTableId = _tableId;

library SquareDescription {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SquareDescription", _fieldNames);
  }
