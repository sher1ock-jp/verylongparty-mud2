...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("VeryMonPlayer")));
bytes32 constant VeryMonPlayerTableId = _tableId;

library VeryMonPlayer {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("VeryMonPlayer", _fieldNames);
  }
